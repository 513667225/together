...
public class PayConstants {
	...
	/** 微信公众号 appid  */
	public static final String WX_APPID = "wx97cc5113d8c1a92b";
	
	/** 微信公众号  secret  */
	public static final String WX_SECRET = "40565b235c6ff677b53556a5517088d8";
	
	/** 微信商户号 partner    */
	public static final String WX_PARTNER = "1600677836";
	
	/** 微信商户号的apiKey  partnerkey */
	public static final String WX_PARTNERKEY = "aishangpin2020aishangpin20208888";
	/** 微信统一支付接口  */
