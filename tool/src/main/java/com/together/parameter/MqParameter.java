...
public class MqParameter {
    ...
    public static final String RETURN_MONEY_QUEUE_NAME = "reMoneyQueue";
    public static final String SHARE_OUT_BONUS_QUEUE_NAME = "shareOutBonusQueue";
    public static final String SHOP_SHARE_QUEUE_NAME = "shopShareQueue";
    ...
    public static final String RETURN_MONEY_EXCHANGE_KEY_NAME = "direct.key";
    public static final String SHARE_OUT_BONUS_EXCHANGE_KEY_NAME = "direct.key";
    public static final String SHOP_SHARE_EXCHANGE_KEY_NAME = "direct.key";
    ...
    public static final String RETURN_MONEY_EXCHANGE_NAME = "reMoneyQueueExchange";
    public static final String SHARE_OUT_BONUS_EXCHANGE_NAME = "shareOutBonusExchange";
    public static final String SHOP_SHARE_EXCHANGE_NAME = "shopShareExchange";
}
